  ...
  useEffect(() => {
    if ((playMode === 'research' || playMode === 'history_analysis') && gameState && gameState.status === 'playing') {
      ...
      const timerId = setTimeout(() => {
        ...
        let depth = isDeepAnalysis ? 7 : 6; 
        if (isDeepAnalysis && emptyCount <= 12) depth = emptyCount;
        else if (!isDeepAnalysis && emptyCount <= 10) depth = emptyCount;
