...
const minimax = (board, depth, alpha, beta, isMaximizing, color, origColor) => {
  ...
  if (moves.length === 0) {
    ...
    if (getSimulatedMoves(board, opp).length === 0) {
      ...
      return myCount > oppCount ? 500 : (myCount < oppCount ? -500 : 0);
    }
                ...
                {researchData.actualMoveEval ? (
                  <div className={`p-2 rounded-lg text-center text-xs font-bold h-full flex items-center justify-center ${
                    ...
                    <span className="opacity-70 ml-2">
                      ({ (gameState?.turn === 'white' ? -clampScore(researchData.actualMoveEval.score) : clampScore(researchData.actualMoveEval.score)) > 0 ? '+' : '' }
                      { gameState?.turn === 'white' ? -clampScore(researchData.actualMoveEval.score) : clampScore(researchData.actualMoveEval.score) } / {researchData.actualMoveEval.judgment})
                    </span>
                  </div>
