  ...
  useEffect(() => {
    if ((playMode === 'research' || playMode === 'history_analysis') && gameState && gameState.status === 'playing') {
      ...
      const timerId = setTimeout(() => {
        ...
        // ▼ 修正: 精度アップ。超解析なら深さ7、通常は深さ6。終盤は完全読み切り
        ...
        {(playMode === 'research' || playMode === 'history_analysis') && (
          <div className="bg-white p-3 rounded-xl shadow-sm mb-4 border border-blue-100 flex flex-col shrink-0" style={{ height: playMode === 'history_analysis' ? '216px' : '172px' }}>
            <div className="flex justify-between items-center mb-2 shrink-0 h-6">
              ...
              <span className={`text-sm font-black ${researchData.isAnalyzing ? 'text-gray-500' : researchData.evaluation > 0 ? 'text-gray-800' : researchData.evaluation < 0 ? 'text-gray-400' : 'text-gray-500'}`}>
