...
function OthelloApp() {
  ...
  const handleInitialRegistration = async () => {
    ...
    setInitError(null);
    const newProfile = { name: initName.trim(), rating: 1000, highestRating: 1000, highestRank: null, wins: 0, losses: 0, draws: 0, currentStreak: 0, history: [], ratingHistory: [], friends: [], theme: 'green', resetVersion: RESET_VERSION };
